...
/**
 * Examples:
 * array_map_items($arr, ['propName1'=>'newPropName1', 'propName2'=>'newPropName2', ...] or fn($curPropName(n)){ ... return $newPropName(n); }
 *
 * @param  array  $array
 * @param  array  $map
...
function array_map_items($array = null, $map = null, $index_prop = null, $add_missing = null, $missing_default = null)
{
	...
	foreach ($array as $index => $item)
	{
		...
		$mapped_index = $index_prop ? array_get($mapped_item, $index_prop, $index) : $index;
